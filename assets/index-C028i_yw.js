(function(){const r=document.createElement("link").relList;if(r&&r.supports&&r.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))n(e);new MutationObserver(e=>{for(const i of e)if(i.type==="childList")for(const s of i.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&n(s)}).observe(document,{childList:!0,subtree:!0});function o(e){const i={};return e.integrity&&(i.integrity=e.integrity),e.referrerPolicy&&(i.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?i.credentials="include":e.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(e){if(e.ep)return;e.ep=!0;const i=o(e);fetch(e.href,i)}})();function c(){const t=document.getElementById("mode"),r=document.getElementById("logo");if(t){const o=t.getAttribute("href");o==="/portfolioGit.io/src/style.css"?(console.log("dark"),t.setAttribute("href","/portfolioGit.io/src/light.css"),r.setAttribute("src","./img/Frame2.png")):o==="/portfolioGit.io/src/light.css"&&(console.log("light"),t.setAttribute("href","/portfolioGit.io/src/style.css"),r.setAttribute("src","./img/Frame.png"))}}function d(t){t.innerHTML=`
    <div class="screen">
        <div id = "rightBlock">
