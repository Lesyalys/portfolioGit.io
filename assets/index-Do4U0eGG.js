(function(){const i=document.createElement("link").relList;if(i&&i.supports&&i.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))o(e);new MutationObserver(e=>{for(const t of e)if(t.type==="childList")for(const d of t.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&o(d)}).observe(document,{childList:!0,subtree:!0});function s(e){const t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?t.credentials="include":e.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function o(e){if(e.ep)return;e.ep=!0;const t=s(e);fetch(e.href,t)}})();function n(){document.body.classList.toggle("dark-shem");const r=document.getElementById("mode"),i=document.getElementById("logo"),s=document.body.classList.contains("dark-shem");i.src=s?"./img/Frame2.png":"./img/Frame.png",localStorage.setItem("theme",s?"dark":"light"),localStorage.getItem("theme")==="dark"&&document.body.classList.add("dark-shem"),r.setAttribute("href","./src/style.css")}function c(r){r.innerHTML=`
    <div class="screen">
        <div id = "rightBlock">
