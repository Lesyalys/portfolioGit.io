(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))o(e);new MutationObserver(e=>{for(const r of e)if(r.type==="childList")for(const d of r.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&o(d)}).observe(document,{childList:!0,subtree:!0});function s(e){const r={};return e.integrity&&(r.integrity=e.integrity),e.referrerPolicy&&(r.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?r.credentials="include":e.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function o(e){if(e.ep)return;e.ep=!0;const r=s(e);fetch(e.href,r)}})();function c(){console.log(document.body),document.body.classList.toggle("dark-shem");const i=document.head.querySelector("#mode");console.log(i);const t=document.getElementById("logo"),s=document.body.classList.contains("dark-shem");t.src=s?"./img/Frame2.png":"./img/Frame.png",i.href=s?"/portfolioGit.io/assets/index-CrcVQEFh.css":"/portfolioGit.io/assets/index-CrcVQEFh.css",localStorage.setItem("theme",s?"dark":"light"),localStorage.getItem("theme")==="dark"&&document.body.classList.add("dark-shem")}function n(i){i.innerHTML=`
    <div class="screen">
        <div id = "rightBlock">
