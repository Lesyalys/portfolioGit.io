(function(){const i=document.createElement("link").relList;if(i&&i.supports&&i.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))n(e);new MutationObserver(e=>{for(const t of e)if(t.type==="childList")for(const s of t.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&n(s)}).observe(document,{childList:!0,subtree:!0});function o(e){const t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?t.credentials="include":e.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function n(e){if(e.ep)return;e.ep=!0;const t=o(e);fetch(e.href,t)}})();const c="/portfolioGit.io/assets/Frame-BiBeJLeF.png",d="/portfolioGit.io/assets/Frame2-DxyYlmui.png";function a(){const r=document.getElementById("mode"),i=document.getElementById("logo");r&&i&&(r.getAttribute("href").includes("style.css")?(r.setAttribute("href","src/light.css"),i.setAttribute("src",d)):(r.setAttribute("href","src/style.css"),i.setAttribute("src",c)))}function m(r){r.innerHTML=`
    <div class="screen">
        <div id = "rightBlock">
      ...
      <footer></footer>
    `,document.getElementById("meDark").addEventListener("click",()=>a())}m(document.querySelector("#app"));
