(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))o(e);new MutationObserver(e=>{for(const i of e)if(i.type==="childList")for(const d of i.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&o(d)}).observe(document,{childList:!0,subtree:!0});function s(e){const i={};return e.integrity&&(i.integrity=e.integrity),e.referrerPolicy&&(i.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?i.credentials="include":e.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function o(e){if(e.ep)return;e.ep=!0;const i=s(e);fetch(e.href,i)}})();function c(){document.body.classList.toggle("dark-shem");const r=document.head.querySelector("#mode");console.log(r);const t=document.getElementById("logo"),s=document.body.classList.contains("dark-shem");t.src=s?"./img/Frame2.png":"./img/Frame.png",r.href=s?"./src/style.css":"./src/light.css",localStorage.setItem("theme",s?"dark":"light");const o=localStorage.getItem("theme");o==="dark"?document.body.classList.add("dark-shem"):o==="light"&&document.body.classList.add("light-shem")}function n(r){r.innerHTML=`
    <div class="screen">
        <div id = "rightBlock">
